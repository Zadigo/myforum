...
class Poll(models.Model):
    ...
    public = models.BooleanField(
        default=True,
        help_text='Determines whether the votes are visible by all'
    )
    voters_alone = models.BooleanField(
        default=True,
        help_text='Determines whether the results are visible by voters alone'
    )
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['thread'], name='one_poll_per_thread')
        ]
...
class Answer(models.Model):
    ...
    possibilities = models.ManyToManyField(Possibility)
    created_on = models.DateField(auto_now_add=True)
    
    class Meta:
        verbose_name = _('answer')
        # constraints = [
        #     UniqueConstraint(fields=['poll', 'user'], name='one_answer_per_user')
        # ]
