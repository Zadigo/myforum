<template>
  <nav :class="{ 'navbar-dark text-light bg-dark': darkMode, 'navbar-light text-dark': !darkMode }"
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarButtonsExample">
        ...
        <button class="btn btn-light shadow-none border rounded w-50 ms-4 text-right" @click="store.openSearchModal=true">
          Search
        </button>
...
export default {
  ...
  setup() {
    ...
    var { darkMode, toggleDarkMode } = inject('dark_mode')
