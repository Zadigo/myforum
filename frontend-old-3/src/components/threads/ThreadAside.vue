  ...
  <aside>
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text mb-0"><span class="fw-bold h4">{{ currentThread?.participants.length || 0 }}</span> participants</p>
...
export default {
  ...
  methods: {
    formatDuration(d) {
      const dateObject = dayjs(d)
      const currentDate = dayjs()
      return dayjs.duration(dateObject.diff(currentDate), 'days').humanize(true)
    }
  }
}
</script>
