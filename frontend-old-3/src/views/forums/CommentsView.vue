          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-actions text-right">
                <div class="btn-group">
                  <button type="button" class="btn btn-primary" @click="createNewPost">Post</button>
                  <button type="button" class="btn btn-info" @click="saveDraft">Save draft</button>
                  <button type="button" class="btn btn-info" @click="handleCancel">Cancel</button>
                </div>
              </div>
            </div>
          </div>
  ...
  methods: {
    async getComments(page = 1) {
      ...
      try {
        ...
        const response = await this.$http.get(`threads/${currentThreadId}/comments`, { params: { page: page } })
